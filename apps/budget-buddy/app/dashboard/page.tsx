    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4 md:mb-0">Welcome, {user.username}!</h1>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Link href="/expenses">
            ...
            >
              ...
              <h2 className="text-2xl font-semibold mb-2 text-white">Expenses</h2>
          ...
          <Link href="/savings">
            ...
            >
              ...
              <h2 className="text-2xl font-semibold mb-2 text-white">Savings Goals</h2>
          ...
          <Link href="/reports">
            ...
            >
              ...
              <h2 className="text-2xl font-semibold mb-2 text-white">Reports</h2>
              <p className="text-gray-100">View financial reports and analytics</p>
            </motion.div>
          </Link>
        </div>
      </div>
